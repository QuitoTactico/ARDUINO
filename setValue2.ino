...
const char* UBIDOTS_TOKEN = "BBFF-WIrjMHi9oVm236sG3yFUtq1dc5d3om";  // Put here your Ubidots TOKEN
const char* WIFI_SSID = "Juan";      // Put here your Wi-Fi SSID
const char* WIFI_PASS = "abcd1234*";      // Put here your Wi-Fi password 
const char* DEVICE_LABEL = "clase";   //Put here your device label
...
void loop() {
  ...
  ubidots.add("temperatura", value1);// Change for your variable name  
